...
public:
    ...
    Tuple (const Tuple <Top, Bottom...>& other) : Tuple<Bottom...> (other.children_) {
        top_ = other.top_;
    }

    virtual void swap(tuple_type& other) {
        std::optional<type> tmp = other.top_;
        other.top_ = top_;
        top_ = tmp;
